...
```
../Assets/Scripts/AR-Object-Control-Tool
```

Drag and drop the script of your choice onto an object in your scene so that it can be active. It is recommended to add it on the object you want to define as target because if you don't reference any object in the `ObjectToAffect` field, by default the script will take the object it is present on.
